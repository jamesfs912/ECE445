...
HD_PWD='D:/Lab5/Lab5.runs/Lab5_WriteBackMux_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab5_WriteBackMux_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab5_WriteBackMux_0_0.tcl
