...
#
# Script generated by Vivado on Fri Nov 03 10:25:24 -0400 2023
...
#
# Usage        : Lab5.sh
#                Lab5.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Lab5.sh [-reset_run]
#                Lab5.sh [-reset_log]
#                Lab5.sh [-help]
#
...
#                script (type 'Lab5.sh -help' for more information).
#
...
design_libs_elab="-libname xil_defaultlib -libname xlslice_v1_0_2 -libname xlconstant_v1_1_7 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xil_defaultlib xlslice_v1_0_2 xlconstant_v1_1_7)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "Lab5.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Lab5.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.Lab5 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.Lab5 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log Lab5_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Lab5.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Lab5.sh [-help]\n\
Usage: Lab5.sh [-step]\n\
Usage: Lab5.sh [-lib_map_path]\n\
Usage: Lab5.sh [-reset_run]\n\
Usage: Lab5.sh [-reset_log]\n\
Usage: Lab5.sh [-keep_index]\n\
Usage: Lab5.sh [-noclean_files]\n\n\
