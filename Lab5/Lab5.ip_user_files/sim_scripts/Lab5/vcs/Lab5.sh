...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Lab5 xil_defaultlib.glbl -o Lab5_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Lab5_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Lab5_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Lab5_simv.daidir vcs_lib c.obj)
