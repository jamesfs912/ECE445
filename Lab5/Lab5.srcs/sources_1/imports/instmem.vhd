...
type Instruction_Memory is array (0 to 255) of std_logic_vector (7 downto 0);
    signal RAM: Instruction_Memory:=(
            x"30",x"09",x"00",x"01",-- 0X00:  andi $t0, $zero, 1
            x"34",x"09",x"00",x"01",-- 0X04:  ori $t0, $zero, 1
            x"20",x"09",x"00",x"01",-- 0X08:  addi $t0, $zero, 1
            x"24",x"09",x"00",x"03",-- 0X0C:  addiu $t0, $zero, 3
            x"28",x"09",x"ff",x"ff",-- 0X10:  slti $t0, $zero, 0xFFFF
            x"2c",x"09",x"ff",x"ff",-- 0X14:  sltiu $t0, $zero, 0xFFFF
            x"8d",x"09",x"00",x"08",-- 0X18:  lw $t0, 8($zero)
            x"85",x"29",x"00",x"08",-- 0X1C:  addi $t0, $t0, 8
            x"8c",x"20",x"00",x"08",-- 0X20:  sw $t0, 8($zero)
